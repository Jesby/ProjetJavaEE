...
<%@page import="org.w3c.dom.stylesheets.DocumentStyle"%>
    ...
    <section class="section">
      <div class="justify-content-center row">
        <div class="col-lg-8">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Modifier l'enregistrement</h5>
              ...
              <form  action="Editdoc" method="post">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="libelle" class="form-control" value="<c:out value="${ document.getLibelle()}"/>">
                  </div>
                </div>
                 <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Description</label>
                  <div class="col-sm-10">
                    <input type="text" name="description" class="form-control"  value="<c:out value="${ document.getDescription()}"/>">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="domaine" class="form-control"  value="<c:out value="${ document.getDomaine()}"/>">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                   ...
                   <input type="hidden" name="id" value="<c:out value="${document.getId()}"/>" />
                    <button type="submit" class="btn btn-primary">Ajouter</button>
                    <button type="submit" class="justify-content-end btn btn-danger">Annuler</button>
                  </div>
                </div>
