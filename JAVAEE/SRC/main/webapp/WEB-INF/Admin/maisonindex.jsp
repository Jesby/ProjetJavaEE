...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="/JAVA/insertion">
              <i class="bi bi-circle"></i><span>Ajouter un document</span>
            </a>
          </li>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>GESTION DES MAISONS D'EDITIONS</h1>
          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-xl-12">
              ...
              <div class="card info-card customers-card">
                ...
                <div class="card-body">
                  <h5 class="justify-content-center card-title">NOMBRE TOTAL DES MAISON D'EDITION ENREGISTRES</h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>1244</h6>
                      <span class="text-danger small pt-1 fw-bold">12%</span> <span class="text-muted small pt-2 ps-1">Evolution</span>
            ...
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <h5 class="card-title">LISTE DES MAISONS D'EDITION </h5>
                    <button class="btn btn-primary mb-2"  ><a class="dropdown-item" href="/JAVA/inserermaison">Ajouter une maison </a></button>
                  ...
                  <c:remove var="errorMsg"/>
                    ...
                    <c:forEach var="maisons"  items="${maison}">
                       <tr>
                        <th scope="row"><c:out value="${maisons.id_Maison}"/></th>
                        <td><c:out value="${maisons.nomsMaison}"/> </td>
                           <td><button  class="btn btn-danger"><a class="dropdown-item" href="/JAVA/suprimer?id=<c:out value='${documents.id}'/>"><i class="bi bi-trash3-fill"></i></a></button></td>
                      </tr>
