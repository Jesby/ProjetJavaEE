              ...
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <h5 class="card-title">Recent Sales <span>| Today</span></h5>
                    <button class="btn btn-primary"  ><a class="dropdown-item" href="/JAVA/inserertype">Ajouter un auteur</a></button>
                  ...
                  <c:remove var="errorMsg"/>
                    ...
                    <c:forEach var="types"  items="${type}">
                       <tr>
                        <th scope="row"><c:out value="${types.id_Doc}"/></th>
                        <td><c:out value="${types.designation}"/> </td>
                          <td><button  class="btn btn-primary" ><a class="dropdown-item" href="/JAVA/edit?id=<c:out value='${documents.id}'/>">Edit</a></button>
                          <button  class="btn btn-danger"><a class="dropdown-item" href="/JAVA/suprimer?id=<c:out value='${documents.id}'/>">Del</a></button></td>
                      </tr>
