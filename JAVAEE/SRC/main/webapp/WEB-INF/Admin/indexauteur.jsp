          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-xl-12">
              ...
              <div class="card info-card customers-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">NOMBRE TOTAL D'AUTEURS </h5>
            ...
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <h5 class="card-title">LISTE TOTAL DES AUTEURS ENREGISTRES</h5>
                    <button class="btn btn-primary mb-2"  ><a class="dropdown-item" href="/JAVA/insererauteur">Ajouter un auteur</a></button>
                  ...
                  <c:remove var="errorMsg"/>
                    ...
                    <c:forEach var="auteurs"  items="${auteur}">
                       <tr>
                        <th scope="row"><c:out value="${auteurs.id}"/></th>
                        <td><c:out value="${auteurs.noms}"/> </td>
                         <td><c:out value="${auteurs.prenom }"/> </td>
                          <td><c:out value="${auteurs.nation }"/> </td>
                          <td>
                           <button  class="btn btn-danger"><a class="dropdown-item" href="/JAVA/suprimer?id=<c:out value='${documents.id}'/>"><i class="bi bi-trash3-fill"></i></a></button></td>
                      </tr>
